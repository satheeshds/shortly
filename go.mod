module github.com/satheeshds/shortly
...
replace github.com/satheeshds/shortly/services => ./services

replace github.com/satheeshds/shortly/controllers => ./controllers
